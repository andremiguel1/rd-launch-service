...
const URL_LAUNCH = 'https://api.spacexdata.com/v4/launches/next';

export class GetNextLaunchController implements Controller<Launch> {
  constructor(protected readonly httpClientHelper: HttpClientHelper<Launch>) {}

  public async handle(): Promise<Launch> {
    console.log('Get Next Launch Controller Handle: start');
    ...
    console.log('Get Next Launch Controller Handle: finish');
